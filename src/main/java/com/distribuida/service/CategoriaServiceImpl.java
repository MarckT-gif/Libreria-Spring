...
public class CategoriaServiceImpl implements CategoriaService {
    ...
    public Categoria update(int id, Categoria categoria) {
        ...
        categoria2.orElse(null).setCategoria(categoria.getCategoria());
        categoria2.orElse(null).setDescripcion(categoria.getDescripcion());

        return categoriaRepository.save(categoria2.orElse(null));
    }
